      ...
      <div className="max-w-3xl mx-auto px-6 relative z-10">
        <div id="mc_embed_shell">
          ...
          <style>{`
            ...
            #mc_embed_signup .mc-field-group label { color: black; font-weight: bold; font-size: 18px; }
            #mc_embed_signup .indicates-required { font-size: 16px; text-align: left; }
            ...
            #mc_embed_signup input.email { border: 1px solid rgba(0,0,0,0.2); border-radius: 0; padding: 1rem; min-height: 50px; font-size: 18px; }
            @media (min-width: 768px) {
              #mc_embed_signup { font: 20px Helvetica,Arial,sans-serif; }
              #mc_embed_signup .mc-field-group label { font-size: 24px; }
              #mc_embed_signup .indicates-required { font-size: 20px; }
              #mc_embed_signup input.email { font-size: 20px; }
            }
          `}</style>
